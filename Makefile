##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.18.0-B7] date: [Thu Nov 16 17:08:45 CET 2023] 
##########################################################################################################################
...
Middlewares/Third_Party/GISTRE_Compiler_GCOV/IO/libgcov9_coverage.c \
Middlewares/Third_Party/GISTRE_Compiler_GCOV/IO/libgcov9_syscall.c
...
-IGCOV \
-IMiddlewares/Third_Party/GISTRE_Compiler_GCOV/IO/include/ \
-IMiddlewares/Third_Party/GISTRE_Compiler_GCOV/IO
...
CFLAGS_COV= -ftest-coverage -fprofile-arcs
...
OBJECTS += $(addprefix $(BUILD_DIR)/,$(notdir $(C_COV_SOURCES:.c=.o)))
